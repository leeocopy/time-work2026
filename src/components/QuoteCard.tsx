            ...
            <div className="flex justify-between items-start mb-6">
                <div className="flex flex-col">
                    <h3 className="text-xl md:text-2xl font-black italic flex items-center gap-2 md:gap-3 text-white">
                        <QuoteIcon className="w-6 h-6 md:w-8 md:h-8" />
                        CITATION DU JOUR
                    </h3>
                </div>
            </div>

            <div className="bg-white text-black p-4 md:p-6 border-4 border-black shadow-[6px_6px_0px_#000] md:shadow-[8px_8px_0px_#000] rotate-1 group-hover:rotate-0 transition-transform">
                <p className="text-lg md:text-xl font-bold text-center leading-[1.8] font-arabic mb-4" dir="rtl">
                    {quote.text}
                </p>
                <div className="flex items-center gap-3 justify-center">
                    <span className="text-[8px] md:text-[10px] font-black uppercase tracking-[0.2em] text-black/40">
                        {quote.author}
                    </span>
                </div>
            </div>
